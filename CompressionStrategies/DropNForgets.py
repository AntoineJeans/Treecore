...
class DropNForgetsClassification(BaseCompressionStrategy):
    def __init__(self, n, allow_cache = False, remember=True, **kwargs):
        super().__init__(**kwargs)
        self.forget_counts = None
        self.n = n
    ...
    def get_strategy_mask(self, y_over_time, y):
        if self.forget_counts is not None and self.allow_cache:
            # if already calculated
            return self.forget_counts > self.n
